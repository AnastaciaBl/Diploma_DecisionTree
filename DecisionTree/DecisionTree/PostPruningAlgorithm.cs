...
namespace DecisionTree
{
    public class PostPruningAlgorithm
    {
        ...
        public RegressionTree TheBestTree;

        public PostPruningAlgorithm(RegressionTree startTree, double penaltyForComplicatedTree, Data[] testSample)
        {
        ...
        private RegressionTree cutUselessNodes(Data[] testSample)
        {
        ...
        private int findIndexOfTheBestTree(List<RegressionTree> trees, Data[] testSample)
        {
        ...
        private double findValueOfTree(RegressionTree tree, Data[] testSample)
        {
            double value = -1;
        ...
        private List<double> findValuesOfNodes(RegressionTree tree)
        {
            List<double> values = new List<double>();
        ...
        private double findErrorOfTree(RegressionTree tree, Data[] testSample)
        {
            double error = 0;
        ...
        private RegressionTree createNewTree(RegressionTree tree, int positionOfExtraNode)
        {
            RegressionTree newDt = new RegressionTree(tree);
            int counter = 0;
            Queue<DecisionTreeNode> qe = new Queue<DecisionTreeNode>();
